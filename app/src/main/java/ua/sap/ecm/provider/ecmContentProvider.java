...
public class EcmContentProvider extends ContentProvider {
    private static final String TAG = EcmContentProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "ua.sap.ecm.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_SITE = 0;
    private static final int URI_TYPE_SITE_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, SiteColumns.TABLE_NAME, URI_TYPE_SITE);
        URI_MATCHER.addURI(AUTHORITY, SiteColumns.TABLE_NAME + "/#", URI_TYPE_SITE_ID);
    }

    protected EcmSQLiteOpenHelper mEcmSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mEcmSQLiteOpenHelper = EcmSQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_SITE:
                return TYPE_CURSOR_DIR + SiteColumns.TABLE_NAME;
            case URI_TYPE_SITE_ID:
                return TYPE_CURSOR_ITEM + SiteColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mEcmSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mEcmSQLiteOpenHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mEcmSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mEcmSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mEcmSQLiteOpenHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_SITE:
            case URI_TYPE_SITE_ID:
                res.table = SiteColumns.TABLE_NAME;
                res.tablesWithJoins = SiteColumns.TABLE_NAME;
                res.orderBy = SiteColumns.DEFAULT_ORDER;
                break;
